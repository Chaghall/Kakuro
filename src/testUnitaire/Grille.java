...
public class Grille {
	...
	public Grille()
	{
		...
		forme = formeGrille(Utilitaire.x-1, Utilitaire.y-1, List);
		valeur = remplissageValGrille(Utilitaire.x, Utilitaire.y, List, forme);
	...
	public Grille(int x, int y, int seed)
	{
		
		grille = new Case[x][y];
		Random List = new Random(seed);
		forme = formeGrille(x-1, y-1, List);
		valeur = remplissageValGrille(x, y, List, forme);
